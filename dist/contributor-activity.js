...
export class ContributorActivityTracker {
    ...
    async getContributorActivity(owner, repo) {
        ...
        return {
            ...
            activeContributors30Days: allContributors.filter(c => c.commits30Days > 0 || c.prsCreated30Days > 0 || c.prsReviewed30Days > 0).length,
            activeContributors90Days: allContributors.length, // All are active since we only fetched recent commits
            activityDistribution,
            topContributors
        };
    }
    calculateActivityDistribution(contributors) {
    ...
    getTopContributors(contributors, limit) {
        return contributors
            .sort((a, b) => {
...
//# sourceMappingURL=contributor-activity.js.map